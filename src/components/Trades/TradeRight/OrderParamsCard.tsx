...
import { Drawer, Slider, TextField, useMediaQuery, useTheme } from '@mui/material'
...
type OrderParamsCardLayout = {
  isOpen?: boolean
  setIsOpen?: (isOpenSelectToken: boolean) => void
  children: JSX.Element
}

export const OrderParamsCardLayout = ({ isOpen, setIsOpen, children }: OrderParamsCardLayout) => {
...
export const OrderParamsCard = ({
  ...
  return (
    <>
      ...
      />
      <OrderParamsCardLayout isOpen={openDrawer} setIsOpen={setOpenDrawer}>
        <>
          {!showConfirmTip && (
            <div
              css={css`
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    <span>
                      {isNaN(positionSizeDai.toNumber()) ? '--' : getBigNumberStr(positionSizeDai, 6)}{' '}
                      {tradePool?.symbol}
                    </span>
                  </p>
                  <p
            ...
            <>
              ...
              >
                ...
                <div className="content order-limit">
                  <p>1. Order Limit</p>
                  <p>
                    When placing orders, be aware that the total quantity of your position, inclusive of leverage,
                    should not exceed 20% of the total market liquidity. Please review the available liquidity before
                    placing your orders to maintain seamless trading operations.
                  </p>
                </div>
